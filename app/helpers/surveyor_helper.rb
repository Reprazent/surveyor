module SurveyorHelper
  ...
  def q_text(obj)
    ...
    survey_id = obj.is_a?(Question) ? obj.survey_section.survey.id : obj.questions.first.survey_section.survey.id
    "<span class='question_index_#{survey_id}'>#{@n += 1})</span> #{obj.text}"
  end
